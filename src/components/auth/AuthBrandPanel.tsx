...
import { AUTH_COPY, PANEL_MATCH, PANEL_QUOTE } from "./constants";
    ...
    <div className="relative hidden min-w-0 flex-col justify-center overflow-hidden bg-panel-dark p-[clamp(32px,5vw,56px)] min-[840px]:flex">
      ...
      <div className="relative mx-auto w-full max-w-[460px]">
        ...
        <div className="flex items-center gap-[11px]">
          <span className="flex size-[34px] flex-none items-center justify-center rounded-full border border-white/[.14] bg-white/[.08] text-[12.5px] font-semibold text-white">
            {PANEL_QUOTE.initials}
          </span>
          <p className="m-0 text-[13.5px] leading-[1.6] text-slate-400">
            {PANEL_QUOTE.text}{" "}
            <span className="text-slate-500">{PANEL_QUOTE.attribution}</span>
          </p>
        </div>
      </div>
    </div>

...
export default function Hero() {
	return (
		<section className={`${CONTENT_WIDTH} pt-[clamp(48px,7vw,88px)] pb-[clamp(40px,6vw,72px)]`}>
			<div className="grid items-center gap-[clamp(32px,5vw,56px)] [grid-template-columns:repeat(auto-fit,minmax(min(380px,100%),1fr))]">
				<div className="min-w-0">
					...
					<p className="m-0 mb-[30px] max-w-[500px] text-[clamp(16px,1.6vw,18px)] leading-[1.6] text-pretty text-text-secondary">
						Upload your resume once. Paste any job description and Hirable scores the
						match, names what&rsquo;s missing, and writes the cover letter — then keeps
